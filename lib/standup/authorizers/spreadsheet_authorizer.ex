defmodule Standup.Plugs.SpreadsheetAuthorizer do
	import Plug.Conn
  ...
  def call(%Plug.Conn{:private => %{:phoenix_action => action, :phoenix_controller => StandupWeb.SpreadsheetController}} = conn, _default) when action in @actions do
