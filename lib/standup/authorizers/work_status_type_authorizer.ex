defmodule Standup.Plugs.WorkStatusTypeAuthorizer do
	import Plug.Conn
  ...
  def call(%Plug.Conn{:private => %{:phoenix_action => action, :phoenix_controller => StandupWeb.WorkStatusTypeController}} = conn, _default) when action in @actions do
