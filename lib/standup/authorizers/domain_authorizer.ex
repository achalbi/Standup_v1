defmodule Standup.Plugs.DomainAuthorizer do
	import Plug.Conn
  ...
  def call(%Plug.Conn{:private => %{:phoenix_action => action, :phoenix_controller => StandupWeb.DomainController}} = conn, _default) when action in @actions do
